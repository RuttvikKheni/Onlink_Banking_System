...
//   Load Loan Records
    public function Data() {
        ...
        $output .= "
                    ...
                    <p>Employees Reports Date $date</p>
    ...
    public function ColoredTable($header,$data) {
        ...
        $this->SetFont('', 'B');
        // Header
        $w = array(30,35,40,70,30,30,25,25);
        ...
        foreach($data as $row) {
            ...
            $this->Cell($w[1], 6, $row['ename'], 'LR', 0, 'L', $fill);
            $this->Cell($w[2], 6, $row['loginid'], 'LR', 0, 'L', $fill);
            $this->Cell($w[3], 6, $row['email'], 'LR', 0, 'L', $fill);
            $this->Cell($w[4], 6, $row['contact'], 'LR', 0, 'L', $fill);
            $this->Cell($w[5], 6, $row['employee_type'], 'LR', 0, 'L', $fill);
            $this->Cell($w[6], 6, $row['create_date'], 'L', 0, 'L', $fill);
...
// column titles
$header = array('IFSC Code','Name','Login ID','Email ID','Contact','Employee','Join Date','Status');
