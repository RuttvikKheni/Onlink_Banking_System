            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3><?php  echo CreditTransaction(); ?><span>&#8377;</span></h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3><?php  echo DebitTransaction(); ?><span>&#8377;</span></h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                        <h3><?php  echo total_loan_account(); ?><span>&#8377;</span></h3>
                            <p>Loan Account</p>
                        </div>
                        <div class="icon">
                        <i class="fas fa-rupee-sign"></i>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3><?php echo total_fixed_deposits(); ?><span>&#8377;</span></h3>
