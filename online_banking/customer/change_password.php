...
if (isset($_POST['change_pwd'])){
    ...
    if(!empty($old_password)||!empty($new_password) || !empty($confirm_Password)) {
        ...
        $crow  = $stmt->rowcount();
        if ($crow > 0) {
            $sql = "UPDATE customers_master SET password =:new_PassWord where c_id =:id";
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-6 col-lg-6 col-md-6">
                                        <h1 class="text-dark">Change Login Password</h1>
                                        <p class="text-muted">Enter a Change Login Password</p>
                                    </div><!-- /.col -->
                                    <div class="col-sm-6">
