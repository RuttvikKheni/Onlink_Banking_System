                ...
                <!--        You can switch ' data-color="orange" '  with one of the next bright colors: "blue", "green", "orange", "red"          -->
                    	...
                    	<div class="wizard-header">
                        	<h3>
                        	   ...
                        	   <small> Please Register with us to take the benefits of Our Online Banking Facilities</small>
                        	</h3>
                    	</div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="step1">
                              <div class="row">
                                  <h4 class="info-text"> Please Register with us to take the benefits of Our Online Banking Facilities</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                         <div class="form-group">
                                            ...
                                            <input type="date" name="date" class="form-control" placeholder="Locality/Street">
                                          </div>
                                    </div>
                                    <div class="col-sm-12">
                                         <div class="form-group">
                                   ...
                                   <div class="col-sm-5 col-sm-offset-1">
                                    ...
                                    <div class="col-sm-5 col-sm-offset-1">
                                         <div class="form-group">
                                            ...
                                            <input required name="pin" type="text"   class="form-control" placeholder="Account PIN">
                                          </div>
                                    </div>
                                    <div class="col-sm-5 col-sm-offset-1">
                                         <div class="form-group">
