                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card card-default mt-2">
                        <div class="card-header">
                            <div class="card-title"><h1 class="text-dark">View Accounts Reports</h1>
                                <p class="text-muted">Views Accounts Reports</p>
                            </div>
                        </div>
                        <!-- /.card-header -->
                    </div>
...
<script>
    function loadcustomer(statement) {
        ...
        xmlhttp.open("GET","ajaxaccountreport.php?statement="+statement,true);
        xmlhttp.send();
    }
    function load_report(fromDate,toDate) {
        ...
        xmlhttp.open("GET","ajaxloadaccountsreport.php?fromDate="+fromDate+"&toDate="+toDate,true);
        xmlhttp.send();
    }
</script>
