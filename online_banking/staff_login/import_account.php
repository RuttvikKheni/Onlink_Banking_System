    ...
    if (isset($_POST['add_import_account'])) {
        ...
        if ($_FILES['file']['size'] > 0) {
            ...
            while (($line = fgetcsv($file,10000,",")) !== false) {
                $sql = "INSERT INTO account_master(account_type,prefix,min_balance,interest,status) VALUES('". $line[0] ."','". $line[1] ."','". $line[2] ."','". $line[3] ."','". $line[4] ."') ";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <ol class="breadcrumb float-sm-right">
                                            ...
                                            <li class="breadcrumb-item active">Add Import Account</li>
                                        </ol>
                                    </div><!-- /.col -->
                                </div><!-- /.row -->
                            </div>
