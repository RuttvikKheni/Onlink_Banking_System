...
if (isset($_POST['add_import_account'])) {
    ...
    if ($_FILES['file']['size'] > 0) {
        ...
        while (($line = fgetcsv($file,10000,",")) !== false) {
            $sql = "INSERT INTO fixed_deposit(d_type,prefix,min_amt,max_amt,interest,terms,status) VALUES('". $line[0] ."','". $line[1] ."','". $line[2] ."','". $line[3] ."','". $line[4] ."','". $line[5] ."','". $line[6] ."') ";
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-6 col-lg-6 col-md-6">
                                            <h1 class="text-dark">User Import Fixed Deposite</h1>
                                        </div><!-- /.col -->
                                        <div class="col-sm-6">
                                            <ol class="breadcrumb float-sm-right">
                                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                                <li class="breadcrumb-item active">Add Import Fixed Deposite</li>
                                            </ol>
                                        </div><!-- /.col -->
                                    </div><!-- /.row -->
                                </div>
